...
constexpr RecentsScreenSnapshot::Data STYLESHEET_466_466_DARK_RECENTS_SCREEN_SNAPSHOT_DATA = {
    .main_size = gui::StyleSize::RECT(280, 330),
    .title = {
        .main_size = gui::StyleSize::RECT(280, 46),
    ...
    .image = {
        .main_size = gui::StyleSize::RECT(280, 280),
        .radius = 16,
    },
};
...
constexpr RecentsScreen::Data STYLESHEET_466_466_DARK_RECENTS_SCREEN_DATA = {
    ...
    .memory = {
        .main_size = gui::StyleSize::RECT_W_PERCENT(100, 18),
        .main_layout_x_right_offset = 10,
        .label_text_font = gui::StyleFont::SIZE(14),
    ...
    .trash_icon = {
        .default_size = gui::StyleSize::SQUARE(40),
        .press_size = gui::StyleSize::SQUARE(36),
